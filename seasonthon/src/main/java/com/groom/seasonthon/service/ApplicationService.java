...
//                .orElseThrow(() -> new RuntimeException("Job not found with id: " + jobId)); // JobNotFoundException 사용 권장
//
...
//
//        return new ApplicationDto(savedApplication); // ApplicationDto로 변환하여 반환
//    }
//}